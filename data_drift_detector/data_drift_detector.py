...
class DataDriftDetector:
    ...
    calculate_distance:
        ...
        datasets with a given distance metric
    ...
    def __init__(self,
        ...
        real_data_ = copy.deepcopy(real_data)
        synth_data_ = copy.deepcopy(synth_data)
    ...
    def eval_regressor(self):
        ...
        rmse_real = self._rmse(self.y_test, y_pred_real)
        mae_real = mean_absolute_error(self.y_test, y_pred_real)
        r2_real = r2_score(self.y_test, y_pred_real)

        rmse_synth = self._rmse(self.y_test_synth, y_pred_synth)
